...
param = config.set(drug_encoding, 
                   target_encoding, 
                   result_folder = 'smartnet/smartnet_vscode/result/Prism_GIN_transformer', #outputpath2,
                   #input_dim_drug = 1024, 
...
model.save_model('smartnet/smartnet_vscode/result/Prism_GIN_transformer/GIN_Prism_drug_bal_model_seq')
#model.train(train, val, test)
